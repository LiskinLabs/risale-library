...
export const LugatPanel = () => {
  ...
  const filteredWords = useMemo(() => {
    ...
    return lugatKeys.filter((w) => w.toLowerCase().includes(query)).slice(0, 50);
  }, [searchQuery]);
    ...
    <>
      ...
      <aside className={`reader-sidebar-right ${isOpen ? 'open' : ''} glass-panel`}>
        <div className='lugat-panel-inner'>
          ...
          {/* Search */}
          <div className='lugat-search relative z-10 bg-[var(--bg-surface)]'>
          ...
          <div className='lugat-content flex-1'>
            {searchQuery.length > 0 ? (
              ...
              <div className='lugat-empty-state flex h-full flex-col items-center justify-center'>
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='48'
                  height='48'
                  ...
                  viewBox='0 0 24 24'
                  stroke='currentColor'
                  className='mb-4 text-[var(--border-color)]'
                >
                  <path
                    strokeLinecap='round'
                    strokeLinejoin='round'
