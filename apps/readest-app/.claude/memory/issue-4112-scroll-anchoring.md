...
**RESOLVED** — merged in LiskinLabs/risale-ai-studio#4349 (foliate-js fix + submodule bump + browser tests). Kept as reusable paginator scroll-mode knowledge.

LiskinLabs/risale-ai-studio#4112 — two scrolled-mode bugs, ONE root cause.
